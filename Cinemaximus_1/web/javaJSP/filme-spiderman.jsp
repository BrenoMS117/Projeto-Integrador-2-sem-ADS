  ...
  <body>
    ...
    <main>
      <section class="detalhes-filme">
        <img
          src="/img/The Amazing Spiderman  Movie Review.jpg"
          alt="O Espetacular Homem Aranha"
          class="filme-poster"
        />
        <div class="info-filme">
          <h1>O Espetacular Homem Aranha</h1>
          <p>
            Quando Peter descobre uma misteriosa maleta que pertenceu a seu pai,
            ele começa uma jornada para entender o desaparecimento de seus pais
            ? o que o leva diretamente à Oscorp e ao laboratório do Dr. Curt
            Connors (Ifans), antigo sócio de seu pai. E como Peter está em rota
            de colisão com o alter-ego do Dr. Connors, O Lagarto; ele tem que
            tomar decisões que podem alterar vidas, para usar seus poderes e
            moldar seu destino de se tornar um herói.
          </p>
          <div class="info">
            <span> Ação/Ficção Científica</span>
            <span> 2h 16m</span>
            <span> 79% gostaram desse filme</span>
          </div>
        </div>
      </section>
