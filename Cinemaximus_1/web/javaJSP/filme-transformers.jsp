    ...
    <body>
        ...
        <main>
            <section class="detalhes-filme">
                <img
                    src="/img/Transformers_ Revenge of the Fallen (2009).jpeg"
                    alt="Transformers A vingança dos Derrotados"
                    class="filme-poster"
                    />
                <div class="info-filme">
                    <h1>Transformers A vingança dos Derrotados</h1>
                    <p>
                        Passaram-se dois anos desde que Sam Witwicky e os Autobots salvaram a raça
                        humana e tentam ter uma vida normal: Sam está começando a faculdade, enquanto
                        os Autobots trabalham com uma organização militar secreta e tentam construir
                        uma casa para eles na Terra. Porém, um antigo Decepticon conhecido como 'The Fallen'
                        aparece para se vingar, então Sam e sua namorada Mikaela precisam desvendar
                        a história dos Transformes e achar um caminho para derrotá-lo.
                    </p>
                    <div class="info">
                        <span> Ação/Ficção científica</span>
                        <span> 2h 30m</span>
                        <span> 77% gostaram desse filme</span>
                    </div>
                </div>
            </section>

            <section class="sessoes">
                <h2>Datas disponíveis para exibição:</h2>
                <div class="datas">
                ...
                <div class="opcoes">
                    ...
                    <div class="exibicao-horario">
                        <label for="exibicao">Selecione a exibição:</label>
                        <select id="exibicao">
